...
from xml_parser import parse_xml_4020, parse_xml_2055, validate_2055_records
...
def main():
    ...
    tab1, tab2 = st.tabs(["🗂️ Evento 4020 - Pagamentos",
    ...
    with tab2:
        ...
        if uploaded_files_2055:
            ...
            if all_data:
                ...
                # =============================================
                # PRIMEIRO: Tabela de Valores Gerais
                # =============================================
                st.subheader("📊 Valores Gerais - Evento 2055")
                ...
                # =============================================
                # SEGUNDO: Tabela única por filial
                # =============================================
                st.subheader("🏢 Detalhamento por Filial - Evento 2055")
                ...
                # =============================================
                # TERCEIRO: Validações com regras atualizadas
                # =============================================
